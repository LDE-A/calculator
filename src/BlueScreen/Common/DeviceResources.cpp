...
void DX::DeviceResources::CreateDeviceResources() 
{
	...
	// 順序が保存されることに注意してください。
	// アプリケーションの最小限必要な機能レベルを以下で宣言することを忘れないでください
...
void DX::DeviceResources::CreateWindowSizeDependentResources() 
{
	...
	else
	{
		...
		swapChainDesc.SwapEffect = DXGI_SWAP_EFFECT_FLIP_SEQUENTIAL;	// すべての Microsoft Store アプリは、_FLIP_ SwapEffects を使用する必要があります。
